...
CMD_Process:
  ...
  Else If (CMD_Text="switch G P S")
  {
    Send 1
  }
  Else If (CMD_Text="switch G P S outside")
  {
    Send 2
  }
  ;
...
_Read_FS_VARS() {
  ...
  If AC_TYPE_read
  {
    ...
    If (AC_TYPE == "C172SP") Or (AC_TYPE == " OK-DS")
    {
      AC_TYPE := "C72S" ; 4 stellig
    }		
    Else
    {	
      _Error_Message("AC_TYPE: C72S ->" AC_TYPE "<", 6)
      AC_TYPE := "????"
    }
...
3Joy6:: ; HOTAS_Thrust_RM
  ...
  Send {Shift Down}{Alt Down}{PgUp}{Alt Up}{Ctrl Up} ; wie Rotari VSpeed
...
3Joy7:: ; HOTAS_Thrust_RU
  ...
  Send {Shift Down}{Alt Down}{PgDn}{Alt Up}{Ctrl Up} ; wie Rotari VSpeed
